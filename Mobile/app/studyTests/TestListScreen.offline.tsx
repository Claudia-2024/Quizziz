...
const TestListScreenOffline: React.FC = () => {
  ...
  const handleDownloadEvaluations = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to download evaluations: ' + (err as Error).message);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        <Text style={[{ fontFamily: theme.typography.fontFamily.heading }, styles.title]}>
          Past Questions
        </Text>
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          ...
          <View style={styles.emptyActions}>
            ...
            <TouchableOpacity
              style={[styles.primaryBtn, { flex: 1, backgroundColor: '#6b2a66' }]}
